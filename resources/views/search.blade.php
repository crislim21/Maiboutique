...
@section('container')
    <h1 class="text-center">Search Your Favorites Clothes!</h1>
                    ...
                    <div class="col-md-3">
                        <div class="card m-2">
                            ...
                            <div class="card-body">
                                ...
                                <p>Seller : <a href="/sellers/{{ $post->seller->username }}"
                                        class="text-decoration-none">{{ $post->seller->username }}</a></p>
                                <p><a href="/categories/{{ $post->category->slug }}" class="text-decoration-none">
